...
def main():
    ...
    try:
        ...
        _, price_df = data_generator.generate_price_series(  # _ is shorthand for throwaway variable
        ...
        data_processor.log_stationarity(adf_results=adf_results, p_value_threshold=p_value_threshold)
