...
GLOBAL_REQUESTS_PER_MINUTE = "8/minute"  # x requests per minute per IP
GLOBAL_REQUESTS_PER_HOUR = "12/hour"    # x requests per hour per IP

# Heavy computation endpoints (pipeline, models, spillover)
HEAVY_COMPUTATION_PER_MINUTE = "8/minute"   # Very restrictive for expensive operations
HEAVY_COMPUTATION_PER_HOUR = "12/hour"     # x heavy operations per hour max

# Data endpoints (generate_data, fetch_market_data)
DATA_ENDPOINTS_PER_MINUTE = "10/minute"    # Moderate limit for data operations
